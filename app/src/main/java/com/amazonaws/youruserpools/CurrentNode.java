...
public class CurrentNode extends AppCompatActivity  implements OnMapReadyCallback,ClusterManager.OnClusterClickListener<Items>, ClusterManager.OnClusterInfoWindowClickListener<Items>, ClusterManager.OnClusterItemClickListener<Items>, ClusterManager.OnClusterItemInfoWindowClickListener<Items>, GoogleMap.OnMarkerClickListener {
        ...
        if (gMap != null) {
            ...
            gMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                ...
                public void onMapLongClick(LatLng latLng) {
                    Geocoder geocoder = new Geocoder(CurrentNode.this);
                    List<Address> list;
                    try {
...
//Your first functionality
    ...
    private void getDeviceLocation() {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(CurrentNode.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(CurrentNode.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
...
// Zoom out to zoom level 10, animating with a duration of 2 seconds.
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(CurrentNode.this);
...
//        EditText et = (EditText) findViewById(R.id.editText);
        ...
        if (list.size() > 0) {
            ...
            Toast.makeText(CurrentNode.this, "Check Spelling Or Try Again !", Toast.LENGTH_SHORT).show();
        }
...
// Add the cluster item (marker) to the cluster manager.
        ...
        mClusterManager.setRenderer(new CustomClusterRenderer(CurrentNode.this, gMap, mClusterManager));
//
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CurrentNode.this, error.getMessage(), Toast.LENGTH_LONG).show();
