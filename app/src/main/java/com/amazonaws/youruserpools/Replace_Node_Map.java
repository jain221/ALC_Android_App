...
public class Replace_Node_Map extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public static final String TAG1 = Replace_Node_Map.class.getSimpleName();
    double ll,lg;
...
//            getDeviceLocation();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Replace_Node_Map.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void addMarkerGreen(final LatLng latLng, final String title,float color_node,String status) {
        ...
        gMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                showDialog(Replace_Node_Map.this);
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(Replace_Node_Map.this);
    }
...
//        showDialog( Replace_Node_Map.this);
    ...
    private void showDialog(Replace_Node_Map currentLocation) {
        ...
        builder1.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(Replace_Node_Map.this, "Asset Replace SuccessFully!!!", Toast.LENGTH_SHORT).show();

                        if (checkNetworkConnection()) {
                            new HTTPAsyncTask().execute("https://svjuuau0x8.execute-api.eu-west-1.amazonaws.com/default/ISDColumeUpdate");
                            onBackPressed();
                        } else
                            Toast.makeText(Replace_Node_Map.this, "Not Connected!", Toast.LENGTH_SHORT).show();
//                    dialog.dismiss();
