...
public class AddAttributeActivity extends AppCompatActivity {
    ...
    void init() {
        ...
        updateDropdownList(Cognito_Connection.getNewAvailableOptions());
    ...
    private void addAttribute() {
        if(attributeSelected != null) {
            ...
            Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).updateAttributesInBackground(newAttribute, updateHandler);
        }
    }
    ...
    UpdateAttributesHandler updateHandler = new UpdateAttributesHandler() {
        ...
        public void onSuccess(List<CognitoUserCodeDeliveryDetails> attributesVerificationList) {
            // Update successful
            Cognito_Connection.addCurrUserattribute(attributeSelected);
            updateDropdownList(Cognito_Connection.getNewAvailableOptions());
        ...
        public void onFailure(Exception exception) {
            // Update failed
            closeWaitDialog();
            showDialogMessage("Failed to add attribute", Cognito_Connection.formatException(exception));
        }
    };
