...
public class RegisterUser extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (userInput != null) {
                    if (userInput.length() > 0) {
                        userAttributes.addAttribute(Cognito_Connection.getSignUpFieldsC2O().get(givenName.getHint()).toString(), userInput);
                    }
                }
                ...
                if (userInput != null) {
                    if (userInput.length() > 0) {
                        userAttributes.addAttribute(Cognito_Connection.getSignUpFieldsC2O().get(email.getHint()).toString(), userInput);
                    }
                }
                ...
                if (userInput != null) {
                    if (userInput.length() > 0) {
                        userAttributes.addAttribute(Cognito_Connection.getSignUpFieldsC2O().get(phone.getHint()).toString(), userInput);
                    }
                }

                showWaitDialog("Signing up...");

                Cognito_Connection.getPool().signUpInBackground(usernameInput, userpasswordInput, userAttributes, null, signUpHandler);
    ...
    SignUpHandler signUpHandler = new SignUpHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            username.setBackground(getDrawable(R.drawable.text_border_error));
            showDialogMessage("Sign up failed",Cognito_Connection.formatException(exception),false);
        }
    };
