...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void changePassword() {
        ...
        Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).changePasswordInBackground(cPass, nPass, callback);
    }
    ...
    GenericHandler callback = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            newPassword.setBackground(getDrawable(R.drawable.text_border_error));
            currPassword.setBackground(getDrawable(R.drawable.text_border_error));
            showDialogMessage("Password change failed", Cognito_Connection.formatException(exception), false);
        }
    };
