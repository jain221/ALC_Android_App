...
public class VerifyActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        if(Cognito_Connection.isEmailAvailable()) {
            if(Cognito_Connection.isEmailVerified()) {
        ...
        if(Cognito_Connection.isPhoneAvailable()) {
            if(Cognito_Connection.isPhoneVerified()) {
    ...
    private void reqVerfCode() {
        ...
        Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).getAttributeVerificationCodeInBackground(attrReqCode, verReqHandler);
    }
    ...
    private void sendVerfCode() {
        ...
        hideCodeTX();
        Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).verifyAttributeInBackground(attrReqCode, code, verHandler);
    }
    ...
    GenericHandler verHandler = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            // Show error
            closeWaitDialog();
            showDialogMessage("Verification failed",Cognito_Connection.formatException(exception),false);
        }
    };
