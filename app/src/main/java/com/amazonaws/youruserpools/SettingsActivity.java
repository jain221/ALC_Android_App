...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        settings = Cognito_Connection.getUserDetails().getSettings().getSettings();
        ...
        smsSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).setUserMfaSettingsInBackground(settings, updateSettingHandler);
            }
        });
        ...
        totpSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).setUserMfaSettingsInBackground(settings, updatesMFASettingsHandler);
            }
        });
        ...
        totpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).associateSoftwareTokenInBackground(null, registerMFAHandler);
            }
        });
    }
    ...
    private void updateSetting(String attribute, String value) {
        ...
        Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).setUserSettingsInBackground(newSettings, updateSettingHandler);
    }

    private void getDetails() {
        settingsChanged = true;
        Cognito_Connection.getPool().getUser(Cognito_Connection.getCurrUser()).getDetailsInBackground(detailsHandler);
    }
    ...
    GenericHandler updateSettingHandler = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            smsSwitch.toggle();
            toggleSwitch();
            showDialogMessage("Failed to change SMS MFA state", Cognito_Connection.formatException(exception), false);
        }
    };
    ...
    RegisterMfaHandler registerMFAHandler = new RegisterMfaHandler() {
        ...
        public void onFailure(Exception exception) {
            closeWaitDialog();
            showDialogMessage("TOTP MFA registration failed", Cognito_Connection.formatException(exception), false);
        }
    };
    ...
    GenericHandler updatesMFASettingsHandler = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            toggleTotpSwitch();
            closeWaitDialog();
            showDialogMessage("Failed to change TOTP MFA state", Cognito_Connection.formatException(exception), false);
        }
    };
