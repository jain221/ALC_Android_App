...
public class upDateDataBase extends AppCompatActivity  implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_up_date_data_base);
...
//        actionBar.setTitle("                             Update DataBase");
        actionBar.setTitle("Update DataBase");
...
//       lat.setText("IP - " + LatLng );
        ...
        btnAddNewCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(upDateDataBase.this, "Saved", Toast.LENGTH_SHORT).show();
                // perform HTTP POST request
                if (checkNetworkConnection())
                    new HTTPAsyncTask().execute(" https://8jpt28d8fk.execute-api.eu-west-1.amazonaws.com/SendData/ISD");
                else
                    Toast.makeText(upDateDataBase.this, "Not Connected!", Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_ColumeManfucture,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(upDateDataBase.this, error.getMessage(), Toast.LENGTH_LONG).show();
