...
public class SignUpConfirm extends AppCompatActivity {
    ...
    private void sendConfCode() {
        ...
        Cognito_Connection.getPool().getUser(userName).confirmSignUpInBackground(confirmCode, true, confHandler);
    }
    ...
    private void reqConfCode() {
        ...
        Cognito_Connection.getPool().getUser(userName).resendConfirmationCodeInBackground(resendConfCodeHandler);
    ...
    GenericHandler confHandler = new GenericHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            showDialogMessage("Confirmation failed", Cognito_Connection.formatException(exception), false);
        }
    };
    ...
    VerificationHandler resendConfCodeHandler = new VerificationHandler() {
        ...
        public void onFailure(Exception exception) {
            ...
            username.setBackground(getDrawable(R.drawable.text_border_error));
            showDialogMessage("Confirmation code request has failed", Cognito_Connection.formatException(exception), false);
        }
    };
